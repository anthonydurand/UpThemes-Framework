...
$options = array (
    ...
    array(  
        ...
        "desc"  => "Choisissez la couleur du background du site",
        "id"    => "background_color",
        "type"  => "color",
        "value" => "#eeeeee",
    ),
    array(  
        ...
        "desc"  => "Choisissez la feuille de style définissant les couleur du site",
        "id"    => "theme_css",
        "type"  => "select",
        "options" => array(
                "Bleu" => "blue",
        ...
        "default_text" => "Choisissez le fichier css",
        "value" => "blue",
    ),
);
