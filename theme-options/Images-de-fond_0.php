...
$options = array (
    array(
        "name" => "Si vous ne voulez pas d'images qui défilent, supprimez toutes les images de ce menu",
        "type" => "divider",
    ),
    array(  
        "name"  => "Image de fond n°1",
        "desc"  => "Choisissez le fond du site",
        "id"    => "background_image_1",
        "type"  => "image",
        "value" => "Choisissez votre image",
    ),
    array(  
        "name"  => "Image de fond n°2",
        "desc"  => "Choisissez le fond du site",
